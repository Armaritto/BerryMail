        ...
        <form>
          ...
          <div class="form-row mb-3">
            ...
            <div class="Priority-group">
              <button @click="handlePriority(isCritical)" :class="{ 'true': this.isCritical.value, 'false': !this.isCritical.value }" class="btn btn-priority">Critical</button>
              <button @click="handlePriority(isUrgent)"  :class="{ 'true': this.isUrgent.value, 'false': !this.isUrgent.value }" type="submit" class="btn btn-priority">Urgent</button>
              <button @click="handlePriority(isModerate)" :class="{ 'true': this.isModerate.value, 'false': !this.isModerate.value }" type="submit" class="btn btn-priority">Moderate</button>
              <button @click="handlePriority(isDefault)" :class="{ 'true': this.isDefault.value, 'false': !this.isDefault.value }" type="submit" class="btn btn-priority">Default</button>
            </div>
          </div>
          <div class="form-row mb-3">
